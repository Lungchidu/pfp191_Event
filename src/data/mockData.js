...
export const PRODUCTS = [
  ...
  {
    id: 13,
    name: "Gói camera livestream Full HD",
    description: "2 Máy quay chuyên dụng, bàn trộn hình ảnh, kèm kỹ thuật viên livestream chất lượng cao.",
    price: 2500000,
    ...
    categoryId: 13,
    isFlash: false,
    tags: ["camera", "livestream", "quay phim"],
    image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&q=80",
    specs: ["2 Máy quay chuyên dụng", "Bàn trộn hình ảnh", "Kèm kỹ thuật viên"],
  },
  {
    id: 14,
    name: "Kỹ thuật viên vận hành âm thanh",
    description: "Nhân sự kỹ thuật chuyên nghiệp hỗ trợ vận hành, tinh chỉnh âm thanh suốt sự kiện.",
    price: 800000,
    originalPrice: 1000000,
    discount: 20,
    sold: 28,
    ...
    categoryId: 15,
    isFlash: false,
    tags: ["kỹ thuật viên", "âm thanh", "nhân sự"],
    image: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=800&q=80",
    specs: ["Vận hành suốt sự kiện", "Xử lý sự cố nhanh", "Kinh nghiệm 3+ năm"],
  },
  {
    id: 15,
